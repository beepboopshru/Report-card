...
void loop() {
  ...
  setEval("4-1",
    ...
    [
      q("What is the purpose of the Arduino pin connected to the LED?", ["Send an electrical control signal", "Store the sketch permanently", "Measure room temperature"], 0),
      q("Why is ledPin stored in a constant?", ["The same assigned pin is used throughout the sketch", "The LED chooses a new pin every loop", "It turns the USB cable into an input"], 0),
      q("Why must the LED pin be configured before the repeating loop begins?", ["Arduino needs to know that the pin will control a device", "The PDF must open before the circuit works", "The delay function selects the wire color"], 0),
      ...
      q("Which unit does Arduino use for values inside delay()?", ["Milliseconds", "Metres", "Volts"], 0),
